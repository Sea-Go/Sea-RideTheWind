...
type GetArticleRequest struct {
	...
	PublicOnly    bool                   `protobuf:"varint,3,opt,name=public_only,json=publicOnly,proto3" json:"public_only,omitempty"`   // 公开读取仅返回当前可读的已发布版本
	RequesterId   string                 `protobuf:"bytes,4,opt,name=requester_id,json=requesterId,proto3" json:"requester_id,omitempty"` // 作者读取时由认证 HTTP 层传入 UID；RPC 先核作者再取正文
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetArticleRequest) GetPublicOnly() bool {
	if x != nil {
		return x.PublicOnly
	}
	return false
...
func (x *GetArticleRequest) GetRequesterId() string {
	if x != nil {
...
type ListArticlesRequest struct {
	...
	PublicOnly    bool                   `protobuf:"varint,9,opt,name=public_only,json=publicOnly,proto3" json:"public_only,omitempty"`                 // 公开列表在查询/计数前限定发布资格
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListArticlesRequest) GetPublicOnly() bool {
	if x != nil {
		return x.PublicOnly
	}
	return false
...
const file_proto_article_proto_rawDesc = "" +
	...
	"\n" +
	"article_id\x18\x01 \x01(\tR\tarticleId\"\x93\x01\n" +
	"\x11GetArticleRequest\x12\x1d\n" +
	"\n" +
	"article_id\x18\x01 \x01(\tR\tarticleId\x12\x1b\n" +
	"\tincr_view\x18\x02 \x01(\bR\bincrView\x12\x1f\n" +
	...
	"\x04desc\x18\b \x01(\bR\x04desc\x12\x1f\n" +
	"\vpublic_only\x18\t \x01(\bR\n" +
	"publicOnlyB\x12\n" +
