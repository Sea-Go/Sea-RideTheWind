...
var configFile = flag.String("f", "etc/hotcenter.yaml", "the config file")
...
func main() {
	...
	httpx.SetOkHandler(func(ctx context.Context, v interface{}) interface{} {
		return &response.Response{
			Code: hotcommon.Success,
			Msg:  hotcommon.GetErrMsg(hotcommon.Success),
			Data: v,
		}
	})

	httpx.SetErrorHandler(func(err error) (int, interface{}) {
		code := hotcommon.ErrorServerCommon
		msg := hotcommon.GetErrMsg(code)
		var codeErr *hotcommon.CodeError
